...
import { FaLinkedin, FaWhatsapp, FaAward, FaUserTie } from 'react-icons/fa';
    ...
    <section className='about' id='sobre' ref={sectionRef}>
      <div className='about-inner'>
        ...
        <div className='about-content'>
          <div className='section-chip fade-up'>Quem Somos</div>

          <h2 className='section-title fade-up' style={{ textAlign: 'left' }}>
          ...
          <p className='about-bio fade-up'>
            ...
            saúde de todos os portes. Sua expertise abrange desde o cadastro
            inicial no CNES até consultorias complexas de regularização
            sanitária.
          </p>
          ...
          <div className='about-highlights fade-up'>
            ...
            <div className='highlight-item'>
              <div className='highlight-icon'>
                <FaUserTie color='#0d9488' size={17} />
              </div>
              <div className='highlight-text'>
                <strong>Atendimento Personalizado</strong>
                Cada caso tratado individualmente
              </div>
            </div>
            <div className='highlight-item'>
              <div className='highlight-icon'>
                <FaAward color='#0d9488' size={17} />
              </div>
              <div className='highlight-text'>
                <strong>Taxa de Aprovação 100%</strong>
                Histórico comprovado junto ao CNES
              </div>
            </div>
          </div>
